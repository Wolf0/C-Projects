...
namespace ADO.Net_Demo
{
    public static class MovieDB
    {
        ...
        public static List<Movie> GetMovie()
        {
            ...
            string connectionString = @"Data Source=CHRISBEVINEAU\SQLEXPRESS;Initial Catalog=netflix;;Integrated Security=True;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False";
