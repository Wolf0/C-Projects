...
/****** Object:  Database [netflix]    Script Date: 8/1/2017 8:35:57 PM ******/
CREATE DATABASE [netflix]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'netflix', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\netflix.mdf' , SIZE = 2112KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'netflix_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\netflix_log.ldf' , SIZE = 832KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
